topSuite(
    ...
    function() {
        var component,
            ...
            describeTouch =  Ext.supports.Touch ? describe : xdescribe,
            loadStore = function() {
        ...
        describe('onExpand', function() {
            ...
            it('should initialize a BoundListKeyNav on the BoundList', function() {
                ...
                expect(
                    component.getPicker().getNavigationModel() instanceof Ext.view.BoundListKeyNav
                ).toBe(true);
            });
        ...
        describe('doQuery method', function() {
            ...
            describe('remote queryMode', function() {
                ...
                it("should pass the query string using the 'queryParam' as the parameter name", function() {
                    ...
                    component.doQuery('foobar');
                    expect(component.store.load.callCount).toEqual(1);
                    expect(component.store.load.calls[0].args[0].params.customparam).toEqual(
                        'foobar'
                    );
                });
        ...
        describe('doAutoSelect method', function() {
            ...
            it('should autoSelect if you type an blur', function() {
                ...
                runs(function() {
                    component.expand();
                    expect(component.picker.getSelectionModel().lastSelected.get('val')).toBe(
                        'value 34'
                    );
                });
            });
        ...
        describe('forceSelection', function() {
            ...
            describe('not multi', function() {
                describe('with no value', function() {
                    ...
                    itNotIE9m(
                        'should not clear the combobox with custom displayTpl on blur after setValue',
                        function() {
                            component.destroy();
                            makeComponent({
                                displayField: 'text',
                            ...
                            jasmine.focusAndWait(
                                component,
                                null,
                                'component to focus for the first time'
                            );
                            runs(function() {
                                component.setValue('value 2');
                            });
                            jasmine.blurAndWait(
                                component,
                                null,
                                'component to blur for the first time'
                            );

                            jasmine.focusAndWait(
                                component,
                                null,
                                'component to focus for the second time'
                            );

                            jasmine.blurAndWait(
                                component,
                                null,
                                'component to blur for the second time'
                            );
                ...
                describe('with a current value', function() {
                    describe('via configuration', function() {
                        ...
                        itNotIE9m(
                            'should not clear the combobox custom displayTpl and calling setValue on blur',
                            function() {
        ...
        describe('clearFilterOnBlur', function() {
        ...
        describe('typeahead', function() {
            it('should not extend the raw value with typeahead on erase', function() {
                ...
                waitsFor(function() {
                    return (
                        component.getRawValue() === 'text 1' &&
                        component.getTextSelection()[0] === 3
                    );
                });
            ...
            it('should clear any selected text after selection is made', function() {
                ...
                runs(function() {
                    ...
                    component.picker
                        .getSelectionModel()
                        .select([store.findRecord('text', 'text 1')]);
                });
            ...
            var testTypeAheadOnBlur = function(enableForceSelection) {
                it(
                    'should select the appropriate record on blur with forceSelection: ' +
                ...
                it(
                    'should not fire events if we did not change values (no value) with forceSelection: ' +
                        enableForceSelection,
                    function() {
                        var spy = jasmine.createSpy();
                ...
                it(
                    'should not fire events if we did not change values (with value) with forceSelection: ' +
                        enableForceSelection,
                    function() {
                        var spy = jasmine.createSpy();
        ...
        describe('caret position when forceResetCaret is true', function() {
            it('should not scroll to end of long value', function() {
                ...
                component.setValue(
                    'I am a long piece of text which scrolls to end on trigger click'
                );
                component.onTriggerClick();
                ...
                store
                    ...
                    .set(
                        'text',
                        'I am another long text here to replace the earlier text on update value'
                    );
                expect(component.getCaretPos()).toBe(0);
        ...
        describeTouch("ComboBox focus on Touch Devices", function() {
            it('should be no console errors on focus', function() {
                makeComponent({
                    valueField: 'val',
                    displayField: 'text',
                    emptyText: 'text 1',
                ...
                expect(function() {
                    var comboBox = component.el.dom;

                    Ext.testHelper.touchStart(comboBox);
                    component.onFocus(component);
                    Ext.testHelper.touchEnd(comboBox);
                }).not.toThrow();
            });
        });
    }
